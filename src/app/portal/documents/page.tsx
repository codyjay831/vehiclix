...
export default async function DocumentsPage() {
  ...
  const activeDeal = await getActiveDeal(user.id);
        ...
        <div className="max-w-3xl space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm font-medium text-muted-foreground leading-relaxed italic">
              All documents are stored in a private, encrypted environment. They are only accessible by Evo Motors authorized staff for the purpose of verifying your transaction. We never share your personal data with third parties without your explicit consent.
            </p>
          </div>
        </div>
      </div>
