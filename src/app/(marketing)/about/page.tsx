...
export const metadata: Metadata = {
  title: "About Us",
  description: `Learn about the ${BRANDING.companyName} mission to redefine the boutique electric vehicle experience.`,
};
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-3xl space-y-8 mb-24">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground font-medium leading-relaxed">
            {BRANDING.companyName} was born from a simple observation: the transition to electric mobility 
