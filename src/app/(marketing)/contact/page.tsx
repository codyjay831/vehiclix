...
export const metadata: Metadata = {
  title: "Contact Us",
  description: `Get in touch with the ${BRANDING.companyName} team for all your EV showroom and sourcing needs.`,
};
...
export default function ContactPage() {
  const contactDetails = [
    {
      title: "Email Us",
      content: BRANDING.contact.email,
      icon: Mail,
      href: `mailto:${BRANDING.contact.email}`,
    },
    {
      title: "Call Us",
      content: BRANDING.contact.phone,
      icon: Phone,
      href: `tel:${BRANDING.contact.phone.replace(/\D/g, '')}`,
    },
    {
      title: "Visit Our Showroom",
      content: BRANDING.contact.address,
      icon: MapPin,
      href: `https://maps.google.com?q=${encodeURIComponent(BRANDING.contact.address)}`,
    },
  ];
