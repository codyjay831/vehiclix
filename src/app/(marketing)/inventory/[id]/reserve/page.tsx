      ...
      <div className="flex flex-col space-y-12 max-w-5xl mx-auto">
        ...
        <div className="space-y-4 text-center md:text-left">
          ...
          <h1 className="text-4xl md:text-6xl font-black tracking-tighter uppercase italic leading-none">
            Reserve Your <span className="text-primary">{BRANDING.companyName.split(' ')[0]} EV</span>
          </h1>
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onInitiate)} className="space-y-8">
                  ...
                  >
                    ...
                    {!isInitiating && <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />}
                  </Button>
                </form>
              </Form>
            ) : (
