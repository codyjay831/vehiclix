...
export const metadata: Metadata = {
  title: "Find Your EV",
  description: "Can't find your dream electric vehicle? Let our sourcing specialists find it for you.",
};
      ...
      <main className="flex-1 pt-32 pb-20 px-6 lg:px-8 max-w-5xl mx-auto w-full">
        ...
        <div className="flex flex-col items-center text-center space-y-6 mb-20">
          ...
          <p className="text-lg md:text-xl text-muted-foreground font-medium max-w-2xl leading-relaxed">
            Tell us exactly what you're looking for. Our team will search auction networks 
