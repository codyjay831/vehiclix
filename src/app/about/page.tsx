...
export const metadata: Metadata = {
  title: "About Us",
  description: "Learn about the Evo Motors mission to redefine the boutique electric vehicle experience.",
};
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="max-w-3xl space-y-8 mb-24">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground font-medium leading-relaxed">
            Evo Motors was born from a simple observation: the transition to electric mobility 
            deserves a purchasing experience as sophisticated as the vehicles themselves.
          </p>
        </div>
        ...
        <div className="bg-primary/5 rounded-3xl p-10 md:p-20 text-center space-y-8 border border-primary/10">
          <div className="max-w-2xl mx-auto space-y-6">
            ...
            <p className="text-lg text-muted-foreground font-medium">
              ...
              Baytech Smart Homes, we integrate your vehicle purchase with home energy 
