...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('OWNER', 'CUSTOMER', 'SUPER_ADMIN', 'STAFF');
...
-- CreateIndex
CREATE UNIQUE INDEX "Vehicle_organizationId_slug_key" ON "Vehicle"("organizationId", "slug");
